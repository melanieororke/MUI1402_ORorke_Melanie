...
//Rare exceptions to indicate a bug in the _miu1401_ororke_melanie_weekfour code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MIU1401_ORorke_Melanie_WeekFour proxies.
 */
