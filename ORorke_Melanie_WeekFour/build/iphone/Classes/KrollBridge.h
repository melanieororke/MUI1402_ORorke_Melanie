...
@interface MIU1401_ORorke_Melanie_WeekFourObject : KrollCoverageObject {
#else
@interface MIU1401_ORorke_Melanie_WeekFourObject : KrollObject {
#endif
@private
...
extern NSString * MIU1401_ORorke_Melanie_WeekFour$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MIU1401_ORorke_Melanie_WeekFourObject *_miu1401_ororke_melanie_weekfour;
    KrollObject* console;
	BOOL shutdown;
