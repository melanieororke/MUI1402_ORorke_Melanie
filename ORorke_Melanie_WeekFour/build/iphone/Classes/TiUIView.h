...
/**
 Base class for all MIU1401_ORorke_Melanie_WeekFour views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU1401_ORorke_Melanie_WeekFour view hierarchy (such as wrapped iOS UIViews) was touched.
