...
/**
 The base class for all MIU1401_ORorke_Melanie_WeekFour modules
 */
...
/**
 MIU1401_ORorke_Melanie_WeekFour Platform calls this method on startup.
 */
-(void)startup;

/**
 MIU1401_ORorke_Melanie_WeekFour Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MIU1401_ORorke_Melanie_WeekFour Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MIU1401_ORorke_Melanie_WeekFour Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MIU1401_ORorke_Melanie_WeekFour Platform calls this method on resume.
 @param sender The sender of the event.
 */
