...
//@interface MIU1401_ORorke_Melanie_WeekFourObject : NSObject
//@end

@interface MIU1401_ORorke_Melanie_WeekFourObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU1401_ORorke_Melanie_WeekFourObject class]])
		{
			for (NSString *key in [[(MIU1401_ORorke_Melanie_WeekFourObject*)o modules] allKeys])
			{
