...
// in simulator we redefine to format for MIU1401_ORorke_Melanie_WeekFour Developer console
...
{\
	NSString * exceptionName = [@"org.miu1401_ororke_melanie_weekfour." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu1401_ororke_melanie_weekfour";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemNone = -1, 
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemSpinner = -2,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemProgressBar = -3,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemSlider = -4,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemSwitch = -5,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemMultiButton = -6,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemSegmented = -7,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemTextView = -8,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemTextField = -9,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemSearchBar = -10,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemPicker = -11,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemDatePicker = -12,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemInfoLight = -13,
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemInfoDark = -14,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemDisclosure = -15,
	
	UIMIU1401_ORorke_Melanie_WeekFourNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU1401_ORorke_Melanie_WeekFour instances of
